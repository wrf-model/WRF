...
- Unofficial, community-maintained AI-agent skill for onboarding new users (not an official wrf-model resource): [earth-space-ai/wrf-skill](https://github.com/earth-space-ai/wrf-skill). It restructures the existing WRF documentation for AI coding agents and defers to this repository as the source of truth.
