...
!      cgrib=' '
      ...
      cgrib(3)=grib(3:3)   
      cgrib(4)=grib(4:4)   
      call g2lib_sbyte(cgrib,zero,32,16)           ! reserved for future use
      call g2lib_sbyte(cgrib,listsec0(1),48,8)     ! Discipline
      call g2lib_sbyte(cgrib,listsec0(2),56,8)     ! GRIB edition number
...
!
      ...
      call g2lib_sbyte(cgrib,one,iofst,8)     ! Store section number ( 1 )
      iofst=iofst+8
      !
      ...
      do i=1,mapsec1len
        nbits=mapsec1(i)*8
        call g2lib_sbyte(cgrib,listsec1(i),iofst,nbits)
        iofst=iofst+nbits
      enddo
      !
      ...
      call g2lib_sbyte(cgrib,lensec1,ibeg,32)
!
!  Put current byte total of message into Section 0
!
      call g2lib_sbyte(cgrib,zero,64,32)
      call g2lib_sbyte(cgrib,lensec0+lensec1,96,32)
