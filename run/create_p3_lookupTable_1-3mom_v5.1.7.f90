...
!--------------------------------------------------------------------------------------------
 ...
 !-----
 character(len=20), parameter :: version   = '5.1.7'
...
! i_rhor  = 1
 ...
 i_Znorm=1 ! note: this needs to be specified running in serial, or read in running in parallel
