...
!      mpi_2double_precision
   ...
   use da_control, only : max_ob_levels,missing_r, &
      ...
      use_goesimgobs, pi, earth_radius, satellite_height,use_clddet_zz
   ...
   use da_define_structures, only : maxmin_type, iv_type, y_type, jo_type, j_type, &
      ...
      airsr_type,info_type, model_loc_type, varbc_info_type, varbc_type,cld_qc_type
   ...
   use gsi_thinning, only : r999,r360,rlat_min,rlat_max,rlon_min,rlon_max, &
                            ...
                            makegrids,map2grids, &
                            destroygrids
   use mod_qc, only: qc_SDob,qc_RTCT,qc_rtmt,qc_cwvt,qc_tit, &
