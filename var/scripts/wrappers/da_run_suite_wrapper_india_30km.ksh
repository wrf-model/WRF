...
#export PREV_JOBID=212575
#export SUBMIT_OPTIONS4="#BSUB -w \"done(${PREV_JOBID})\""
#-----------------------------------------------------------------------
#  Here Fix the Dates
#-----------------------------------------------------------------------
export INITIAL_DATE=2005080200
export FINAL_DATE=2005080200
#-----------------------------------------------------------------------
...
export FIRST=false
export EXPT=run_indian_30km_cpu_${NUM_PROCS}
#########################################################################
...
export LONG_FCST_TIME_3=${LONG_FCST_TIME_3:-12}        # Forecast starting time 3
...
#-------------------------------------------------------------------------
export MAP_PROJ=${MAP_PROJ:-mercator}                  # Map Projection
export REF_LAT=${REF_LAT:-20.0}                        # Centre Latitude
export REF_LON=${REF_LON:-80.5}                        # Centre Longitude
export TRUELAT1=${TRUELAT1:-0.0}                       # True LAtitude 1
export TRUELAT2=${TRUELAT2:-35.0}                      # True LAtitude 2
export STAND_LON=${STAND_LON:-80.5}                    # Reference Longitude
#-------------------------------------------------------------------------
# Domains control options in WRF
#-------------------------------------------------------------------------
export NL_E_WE=${NL_E_WE:-151}                         # Number of grid points in X direction (E_W)
export NL_E_SN=${NL_E_SN:-151}                         # Number of grid points in Y direction (N_S)
export NL_E_VERT=${NL_E_VERT:-51}                      # Number of vertical eta levels 
...
export NL_P_TOP_REQUESTED=${NL_P_TOP_REQUESTED:-1000}     # The TOP pressure levels values in hPa 
#------------------------------------------------------------------------
