...
export FIRST=false
export EXPT=run_regional_kma_radar_cpu_${NUM_PROCS}
#-----------------------------------------------------------------------
# Special choices below
#------------------------------------------------------
export QC_OBS_FLAG=false
export VERIFY_FLAG=false
export RUN_WITH_ANALYSIS=false
export RUN_3DVAR_WITH_FILTD_OBS=false
#------------------------------------------------------
export QC_EXPT=filtd_obs
export VERIFY_NAME=cycling  
export VERIFY_WITH="12"
export VERIFY_EXPT="verif_${VERIFY_NAME}_${VERIFY_WITH}"
#########################################################################
