...
!           WRITE (iout,'(A,I)') ' GETH_IDTS:  Day of NDATE = ', dynew
            npass = .false.
         END IF
...
!           WRITE (iout,'(A,I)') ' GETH_IDTS:  Day of ODATE = ', dyold
            opass = .false.
         END IF
...
!           WRITE (iout,'(A,I)') ' GETH_IDTS:  Hour of NDATE = ', hrnew
         npass = .false.
      END IF
...
!           WRITE (iout,'(A,I)') ' GETH_IDTS:  Hour of ODATE = ', hrold
         opass = .false.
      END IF
